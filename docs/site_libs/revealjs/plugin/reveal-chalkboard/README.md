...
Reveal.initialize({
    ...
    chalkboard: {
        ...
        boardmarkers : [
                ...
                { color: 'rgba(220,19,60,1)', cursor: 'url(' + path + 'img/boardmarker-red.png), auto'},
        ...
        chalks: [
                ...
                { color: 'rgba(237, 19, 28, 0.5)', cursor: 'url(' + path + 'img/chalk-red.png), auto'},
                { color: 'rgba(19, 237, 28, 0.5)', cursor: 'url(' + path + 'img/chalk-green.png), auto'},
